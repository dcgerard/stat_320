...
-   Example: If $X \sim \text{Binom}\left(n, \frac{1}{2}\right)$ (the null is true), then 
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "Density plot showing p-value is two times area to the right of the absolute value of the observed value."
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "Bar plot showing mass for exact p-value from binomial test."
