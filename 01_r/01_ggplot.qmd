...
```{r}
#| fig-alt: "Histogram of ls1 with red fill."
library(readr)
library(ggplot2)
...
```{r}
#| eval: false
#| fig-alt: "Barplots of various variables from the lead data."
...
-   Scatterplot:
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Scatterplot of IQF and ld73."
...
-   Jitter points to account for overlaying points.
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Jitterplot of totyrs and hyperact"
...
-   Add a Loess Smoother by adding `geom_smooth()`.
    ...
    ```{r, message=FALSE}
    #| warning: false
    #| fig-alt: "Scatterplot of iqf and ld73 with a smoother."
    ggplot(data = lead, mapping = aes(x = ld73, y = iqf)) +
      geom_point() +
...
## Solution
```{r}
#| fig-alt: "Scatterplot of ls1 and ls2."
...
-   Boxplot
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Boxplot of IQF by group."
...
## Solution
```{r}
#| fig-alt: "Boxplot of ls_diff by zyg."
...
-   Color code a scatterplot by a categorical variable and add a legend.
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Scatterplot of iqf by ld73 color-coded by lead_grp."
...
## Solution
```{r}
#| fig-alt: "Scatterplot of ls1 and ls2 color coded by zyg."
...
-   Add a `scale_*()` call to change the name:
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Scatterplot of iqf and ld37, color coded by lead_grp, with a new name on the legend."
    ggplot(data = lead, mapping = aes(x = ld73, y = iqf, color = lead_grp)) +
      geom_point() +
...
-   The variable to the left of the tilde ("`~`") indexes the row facets, the variable to the right of the tilde indexes the column facets. Using a dot ("`.`") in place of a variable means that there will only be one row/column facet.
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Faceting by area scatterplots of iqf and ld73."
    ggplot(data = lead, mapping = aes(x = ld73, y = iqf)) +
      geom_point() +
      facet_grid(. ~ area)
    ggplot(data = lead, mapping = aes(x = ld73, y = iqf)) +
    ...
    #| warning: false
    #| fig-alt: "Scatterplot of iqf and ld73 faceted by area and group."
    ggplot(data = lead, mapping = aes(x = ld73, y = iqf)) +
      geom_point() +
...
## Solution
```{r}
#| fig-alt: "Histogram of ls_diff, faceted by zyg."
...
-   Add a `theme_*()` function to change the theme:
    ...
    ```{r}
    #| warning: false
    #| fig-alt: "Scatterplot if iqf and ld73 with a classic theme."
    ggplot(data = lead, mapping = aes(x = ld73, y = iqf)) +
      geom_point() +
      theme_classic()
    ```
