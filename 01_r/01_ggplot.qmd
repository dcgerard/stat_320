...
- I will use the `lead` dataset to demonstrate plots
...
- **Exercise**: Load in the [boneden](https://dcgerard.github.io/stat_320/data/boneden.csv) data (see [here](https://dcgerard.github.io/stat_320/data.html#boneden) for a description) and make a histogram of lumbar spine density for the lighter smoking twin with 20 bins. Make the bins red.
...
- **Exercise**: Using the `boneden` data, create a scatterplot between the lumbar spine densities of the two twin types (smoking status), color coding by zygosity.
...
- **Exercise**: Using the `boneden` data, create a histogram of the difference in lumbar spine densities, faceting by zygosity.
