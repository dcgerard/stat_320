...
-   $\chi^2$ with different degrees of freedom
    ...
    #| message: false
    #| warning: false
    #| fig-alt: "Chi-squared density with different degrees of freedom."
    library(tidyverse)
    library(ggthemes)
...
-   Density Function
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "dchisq() is height of density curve."
    library(ggplot2)
...
-   Random Generation
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "rchisq() is random sample."
...
-   Cumulative Distribution Function
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "pchisq() is probability of being less than a value."
...
-   Quantile Function: Rosner denotes the following $t_{2,0.9082}$
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "qchisq(): You give it the probability, it gives you the value such that being less than that value is the given probability."
    x <- seq(0, 12, length = 500)
    y <- dchisq(x,  df = 3)
    polydf <- data.frame(x = c(min(x), x[x < 3], 3, 0), 
                         y = c(0, y[x < 3], 0, 0))
