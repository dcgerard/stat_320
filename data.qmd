...
Data were collected from 20 healthy females, 25–34 years old, to study the relationship between body fat and three predictors [@neter1996applied].

- [body.csv](./data/body.csv)
...
These data come from @greene1963urinary, where they measured the association between the level of estriol in pregnant women and their offspring's birthweight. Estriol is a female sex hormone which is elevated during pregnancy.

- [estriol.csv](./data/estriol.csv)
  - `id`: Patient ID
...
White Leghorn hens, aged 14-29 weeks, were surgically fitted with [cannulas](https://en.wikipedia.org/wiki/Cannula) for collecting biliary and pancreatic secretions, and a jugular cannula for hormone infusion. Each hen underwent one trial per day, as long as her cannulas remained functional, leading to varying trial numbers per hen.
