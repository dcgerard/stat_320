...
#| eval: true
#| message: false
#| fig-alt: "Right skew density plot"
library(ggplot2)
...
#| eval: true
#| message: false
#| fig-alt: "Left skew density plot"
ggplot(data.frame(x = c(-2, 6)), aes(x = x)) +
...
-   Why?
    ...
    #| message: false
    #| warning: false
    #| fig-alt: "Histogram shifted and scaled."
    ggplot(data.frame(x = x * 2), aes(x = x)) +
...
```{r}
#| fig-alt: "Histogram of birthweights."
