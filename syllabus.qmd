...
![](./q1_banner.png){fig-alt="AU Core: Foundation Courses > Quantitative Literacy I (Q1)"}\ 
...
![](./q2_banner.png){fig-alt="AU Core: Integrative Courses > Quantitative Literacy II (Q2)"}\ 
