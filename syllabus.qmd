...
## Data
Data sets for homeworks assignments and examples from the textbook are available on the [book's companion website](http://www.cengage.com/cgi-wadsworth/course_products_wp.pl?fid=M20b&product_isbn_issn=9781305268920&token=). You will want the R or ASCII formats. Other data sets needed for classtime activities will be posted in Canvas 
