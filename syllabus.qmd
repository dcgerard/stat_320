...
- Homeworks:
    - To me (and some of you), homeworks are meant to solidify your understanding. To (some of) you, homeworks are meant to help you prepare for the exams. You can use generative AI if you want. But you won't get any other study aids, so I wouldn't except to check my work after I've done all of the problems.
...
Data sets for homeworks assignments and examples from the textbook are available on the [Data page](data.qmd). These are cleaned versions of the data from the book's [companion website](http://www.cengage.com/cgi-wadsworth/course_products_wp.pl?fid=M20b&product_isbn_issn=9781305268920). Other data sets needed for class will be posted in Canvas 
