...
```{r}
#| echo: false
plt_t(ub = -1.684, df = 19, two_sided = TRUE) +
  geom_vline(xintercept = -1.684, lty = 2)
```
```{r}
2 * pt(q = -1.684, df = 19)
```
...
```{r}
#| echo: false
plt_t(ub = -3.014, rng = c(-5, 5), two_sided = TRUE) +
  geom_vline(xintercept = -3.014, lty = 2)
```
```{r}
2 * pnorm(-3.014)
```
...
```{r}
#| echo: false
plt_t(lb = 3.812, rng = c(-5, 5), two_sided = TRUE) +
  geom_vline(xintercept = 3.812, lty = 2)
```
```{r}
2 * pnorm(-3.812)
```
...
```{r}
#| echo: false
plt_t(lb = 4.194, rng = c(-5, 5), two_sided = TRUE) +
  geom_vline(xintercept = 4.194, lty = 2)
```
```{r}
2 * pnorm(-4.194)
```
...
```{r}
#| echo: false
plt_t(lb = 6.545, rng = c(-7, 7), two_sided = TRUE) +
  geom_vline(xintercept = 6.545, lty = 2)
```
```{r}
2 * pnorm(-6.545)
```
