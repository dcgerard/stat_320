...
```{r}
#| echo: false
plt_t(lb = 0.7261, two_sided = TRUE) +
  geom_vline(xintercept = 0.7261, lty = 2)
```
```{r}
2 * pnorm(-0.7261)
```
...
```{r}
#| echo: false
plt_t(lb = 4.741, rng = c(-6, 6)) +
  geom_vline(xintercept = 4.741, lty = 2)
```
```{r}
1 - pnorm(4.741)
```
...
```{r}
#| echo: false
plt_t(lb = 2.9, rng = c(-5, 5), two_sided = TRUE) +
  geom_vline(xintercept = 2.9, lty = 2)
```
```{r}
2 * pnorm(-2.9)
```
...
```{r}
#| echo: false
plt_t(lb = 3.767, rng = c(-5, 5), two_sided = TRUE) +
  geom_vline(xintercept = 3.767, lty = 2)
```
```{r}
2 * pnorm(-3.767)
```
...
```{r}
#| echo: false
plt_t(lb = 4.152, rng = c(-5, 5), two_sided = TRUE) +
  geom_vline(xintercept = 4.152, lty = 2)
```
```{r}
2 * pnorm(-4.152)
```
...
```{r}
#| echo: false
plt_t(lb = 6.34, rng = c(-7, 7), two_sided = TRUE) +
  geom_vline(xintercept = 6.34, lty = 2)
```
```{r}
2 * pnorm(-6.34)
```
