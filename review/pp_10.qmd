...
## Solution
Let $X_1$ be the number of deaths out of the $n_1 = 199$ males receiving streptokinase. Let $X_2$ be the number of deaths out of the $n_2 = 97$ control males. Then $X_1 \sim \mathrm{Binom}(199, p_1)$ and $X_2 \sim \mathrm{Binom}(97, p_2)$. We are testing $H_0: p_1 = p_2$ versus $H_A: p_1 \neq p_2$. We calculate statistics
