...
-   $H_1: p_1 > p_2$
    ...
    #| fig-height: 2
    #| fig-width: 3
    #| fig-alt: "Density curve showing p-value is area to the right of observed value."
    plt_t(lb = 1.5) +
...
-   $H_1: p_1 < p_2$
    ...
    #| fig-height: 2
    #| fig-width: 3
    #| fig-alt: "Density curve showing p-value is area to the left of observed value."
    plt_t(ub = 1.5) +
      scale_x_continuous(breaks = c(1.5), labels = c("z")) +
      geom_vline(xintercept = 1.5, linetype = "dashed") +
      theme(axis.text.x = element_text(size = 15),
...
-   Birth example:
    ...
    ```{r}
    #| echo: false
    #| fig-alt: "P-value is area to the right of observed value."
